...
%    \draw (0.1, 0) circle [radius = 0.1];
%  \end{tikzpicture}
%  \caption{Schematic of the evenly distributed initial condition for $num = 4$ initial innoculation points.
%  }
%  \label{fig:evenSchema}
%\end{figure}
...
Figure \ref{fig:spatial_even} - \ref{fig:spatial_clump} shows the time evolution of both initial conditions.
